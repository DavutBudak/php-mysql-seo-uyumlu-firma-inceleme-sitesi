...
?>
<?php $limit = 5;
$query = "SELECT count(*) FROM firma_yorumlari WHERE yorum_durum = 1 ";
      ...
      <ol class="breadcrumb">
		...
		<div class="box_general">
			<div class="header_box">
				<h2 class="d-inline-block">Pasif Yorumlar</h2>
                <div class="row" style="list-style: none;" > 
                <div class="col-md-3" style="text-align: center;"> <li  style="border:1px solid black;"><a href="reviews.php?page=1" class="btn gray approve"><i class="fa fa-fw fa-check-circle-o"></i> Bütün Yorumlar</a></li></div>
                ...
                <div class="col-md-3" style="text-align: center;"> <li  style="border:1px solid black;"><a href="" class="btn gray approve"><i class="fa fa-fw fa-check-circle-o"></i> Pasif Yorumlar</a></li></div>
...
$starting_limit = ($page-1)*$limit;
			...
			$yorumlar = $db -> prepare("SELECT * FROM firma_yorumlari WHERE  yorum_durum = 1  ORDER BY id DESC LIMIT $starting_limit,$limit ");
...
?>
		...
		<ul class="pagination pagination-sm add_bottom_30">
         ...
         if($total_pages == 0){}
		  ...
		  <li class="page-item "><a class="page-link" href="<?php echo "reviews_passive.php?page=$gerigit";?>"> Previous </a></li>
...
<li class="page-item"><a class="page-link" href="<?php echo "reviews_passive.php?page=$page"; ?>"> <?php  echo $page; ?>  </a></li>
...
<li class="page-item"><a class="page-link" href="<?php echo "reviews_passive.php?page=$ilerigit"; ?>">Next</a></li>
                      <?php } ?>
					  </ul>
